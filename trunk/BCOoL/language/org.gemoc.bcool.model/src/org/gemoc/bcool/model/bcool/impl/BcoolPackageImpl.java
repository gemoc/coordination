...
public class BcoolPackageImpl extends EPackageImpl implements BcoolPackage {
	 ...
	 * @generated
	 */
	public EAttribute getMatchingRule_Condition() {
		return (EAttribute)matchingRuleEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEventRelation_ActualParameters() {
		return (EAttribute)eventRelationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRelationDeclaration_FormalParameters() {
		return (EAttribute)relationDeclarationEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(matchingRuleEClass, MATCHING_RULE__CONDITION);
		...
		createEAttribute(eventRelationEClass, EVENT_RELATION__ACTUAL_PARAMETERS);
		...
		createEAttribute(relationDeclarationEClass, RELATION_DECLARATION__FORMAL_PARAMETERS);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMatchingRule_Condition(), thePivotPackage.getString(), "condition", null, 0, 1, MatchingRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEventRelation_ActualParameters(), ecorePackage.getEString(), "actualParameters", null, 0, -1, EventRelation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationDeclaration_FormalParameters(), ecorePackage.getEString(), "formalParameters", null, 0, -1, RelationDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
