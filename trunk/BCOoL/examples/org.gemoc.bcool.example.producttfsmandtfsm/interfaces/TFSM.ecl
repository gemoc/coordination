...
-- ECLimport "platform:/plugin/org.gemoc.sample.tfsm.ccslmoc/ccsl/TFSMMoC.ccslLib" 
...
package tfsm
	...
	context FSMClock
		def: ticks : Event = GenericEvent
		 
	context Transition
		def: fire : Event = GenericEvent
	
	context State
		def : entering : Event  = StartEvent
		def : leaving : Event = StopEvent
		
	context EvaluateGuard
		def : evaluate : Event  = GenericEvent
