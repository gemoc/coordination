...
public class ReplyAction extends Action {
  public EOperation pins_match_parameter;
  
  public EOperation event_on_reply_to_call_trigger;
  
  public EReference replyToCall;
  
  public EReference replyValue;
  ...
  public EDataType pins_match_parameter();
  
  public EDataType event_on_reply_to_call_trigger();
