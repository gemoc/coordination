            	    ...
            	    if ( state.backtracking==0 ) {
            	      	        ...
            	      	        if (current==null) {
            	             		...
            	             		add(
            	             			...
            	             			"importsLib",
            	              		lv_importsLib_1_0, 
            	              		"org.gemoc.bcool.model.xtext.BCOoL.ImportLibRule");
            	    ...
            	    if ( state.backtracking==0 ) {
            	      	        ...
            	      	        if (current==null) {
            	             		...
            	             		add(
            	              		...
            	              		"org.gemoc.bcool.model.xtext.BCOoL.ImportInterfaceRule");
            	      	        afterParserOrEnumRuleCall();
            	    ...
            	    if ( state.backtracking==0 ) {
            	      	        ...
            	      	        if (current==null) {
            	             		...
            	             		add(
            	              		...
            	              		"org.gemoc.bcool.model.xtext.BCOoL.BCoolOperatorSpec");
            	      	        afterParserOrEnumRuleCall();
                    ...
                    if ( state.backtracking==0 ) {
                      	        ...
                      	        if (current==null) {
                             		...
                             		add(
                              		...
                              		"org.gemoc.bcool.model.xtext.BCOoL.globalEventExpressionRule");
                      	        afterParserOrEnumRuleCall();
                    ...
                    if ( state.backtracking==0 ) {
                      	        ...
                      	        if (current==null) {
                             		...
                             		add(
                             			...
                             			"globalDSEs",
                              		lv_globalDSEs_3_0, 
                              		"org.gemoc.bcool.model.xtext.BCOoL.globalDSEsRule");
                      	        afterParserOrEnumRuleCall();
            	    ...
            	    if ( state.backtracking==0 ) {
            	      	        ...
            	      	        if (current==null) {
            	             		...
            	             		add(
            	              		...
            	              		"org.gemoc.bcool.model.xtext.BCOoL.BCoolCompositionRule");
            	      	        afterParserOrEnumRuleCall();
            ...
            if ( state.backtracking==0 ) {
              	        ...
              	        if (current==null) {
                     		...
                     		add(
                      		...
                      		"org.gemoc.bcool.model.xtext.BCOoL.BCoolOperatorArg");
              	        afterParserOrEnumRuleCall();
            ...
            if ( state.backtracking==0 ) {
              	        ...
              	        if (current==null) {
                     		...
                     		set(
                     			...
                     			"matchingRule",
                      		lv_matchingRule_8_0, 
                      		"org.gemoc.bcool.model.xtext.BCOoL.MatchingRule");
              	        afterParserOrEnumRuleCall();
            ...
            if ( state.backtracking==0 ) {
              	        ...
              	        if (current==null) {
                     		...
                     		set(
                      		...
                      		"org.gemoc.bcool.model.xtext.BCOoL.CoordinationRule");
              	        afterParserOrEnumRuleCall();
            	    ...
            	    if ( state.backtracking==0 ) {
            	      	        ...
            	      	        if (current==null) {
            	             		...
            	             		add(
            	              		...
            	              		"org.gemoc.bcool.model.xtext.BCOoL.EventExpression");
            	      	        afterParserOrEnumRuleCall();
            ...
            if ( state.backtracking==0 ) {
              	        ...
              	        if (current==null) {
                     		...
                     		set(
                      		...
                      		"org.gemoc.bcool.model.xtext.BCOoL.EventRelation");
              	        afterParserOrEnumRuleCall();
