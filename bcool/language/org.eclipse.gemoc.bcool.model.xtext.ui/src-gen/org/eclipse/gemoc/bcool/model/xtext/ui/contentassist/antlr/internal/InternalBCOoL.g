...
{ before(grammarAccess.getBCoolOperatorSpecAccess().getNameIDTerminalRuleCall_0_1_0()); }
	RULE_ID{ after(grammarAccess.getBCoolOperatorSpecAccess().getNameIDTerminalRuleCall_0_1_0()); }
)
...
{ before(grammarAccess.getBCoolOperatorSpecAccess().getGlobalEventExpressionsGlobalEventExpressionRuleParserRuleCall_1_0()); }
	ruleglobalEventExpressionRule{ after(grammarAccess.getBCoolOperatorSpecAccess().getGlobalEventExpressionsGlobalEventExpressionRuleParserRuleCall_1_0()); }
)
...
{ before(grammarAccess.getBCoolOperatorSpecAccess().getGlobalDSEsGlobalDSEsRuleParserRuleCall_2_0()); }
	ruleglobalDSEsRule{ after(grammarAccess.getBCoolOperatorSpecAccess().getGlobalDSEsGlobalDSEsRuleParserRuleCall_2_0()); }
)
...
{ before(grammarAccess.getBCoolOperatorSpecAccess().getBcoolCompositionRulesBCoolCompositionRuleParserRuleCall_3_0()); }
	ruleBCoolCompositionRule{ after(grammarAccess.getBCoolOperatorSpecAccess().getBcoolCompositionRulesBCoolCompositionRuleParserRuleCall_3_0()); }
)
...
{ before(grammarAccess.getBCoolOperatorArgAccess().getDSEDefPropertyCSIDTerminalRuleCall_4_0_1()); }
	RULE_ID{ after(grammarAccess.getBCoolOperatorArgAccess().getDSEDefPropertyCSIDTerminalRuleCall_4_0_1()); }
)
...
{ before(grammarAccess.getBCoolOperatorArgAccess().getInterfaceClassEClassSTRINGTerminalRuleCall_5_0_1()); }
	RULE_STRING{ after(grammarAccess.getBCoolOperatorArgAccess().getInterfaceClassEClassSTRINGTerminalRuleCall_5_0_1()); }
)
...
{ before(grammarAccess.getEventRelationAccess().getActualParametersDefPropertyCSIDTerminalRuleCall_3_0_0_1()); }
	RULE_ID{ after(grammarAccess.getEventRelationAccess().getActualParametersDefPropertyCSIDTerminalRuleCall_3_0_0_1()); }
)
...
{ before(grammarAccess.getEventRelationAccess().getActualParametersDefPropertyCSIDTerminalRuleCall_3_1_1_0_1()); }
	RULE_ID{ after(grammarAccess.getEventRelationAccess().getActualParametersDefPropertyCSIDTerminalRuleCall_3_1_1_0_1()); }
)
