...
public abstract class AbstractBCOoLLibSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (name=EString (formalParameters+=EString formalParameters+=EString*)?)
	 */
	...
	protected void sequence_ExpressionDefinition(EObject context, ExpressionDefinition semanticObject) {
		...
		feeder.accept(grammarAccess.getExpressionDefinitionAccess().getDefinitionExpressionDeclarationEStringParserRuleCall_3_0_1(), semanticObject.getDefinition());
		feeder.finish();
	}
	...
	protected void sequence_RelationDefinition(EObject context, RelationDefinition semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getRelationDefinitionAccess().getDefinitionRelationDeclarationEStringParserRuleCall_3_0_1(), semanticObject.getDefinition());
		feeder.finish();
	}
}
