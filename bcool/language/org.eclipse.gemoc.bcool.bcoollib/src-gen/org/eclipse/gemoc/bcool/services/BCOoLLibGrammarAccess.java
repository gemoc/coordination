 ...
 * generated by Xtext
 */
package org.eclipse.gemoc.bcool.services;
...
public class BCOoLLibGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BCoolLibraryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.bcool.BCOoLLib.BCoolLibrary");
	...
	public class ExpressionDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.bcool.BCOoLLib.ExpressionDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	'ExpressionDefinition'
		//	'{'
		//	'definition' definition=[ExpressionDeclaration]
		//	'}';
		@Override public ParserRule getRule() { return rule; }
	...
	public class RelationDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.bcool.BCOoLLib.RelationDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	'RelationDefinition'
		//	'{'
		//	'definition' definition=[RelationDeclaration]
		//	'}';
		@Override public ParserRule getRule() { return rule; }
	...
	public class RelationDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.bcool.BCOoLLib.RelationDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExpressionDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.bcool.BCOoLLib.ExpressionDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.gemoc.bcool.BCOoLLib".equals(grammar.getName())) {
				return grammar;
			}
