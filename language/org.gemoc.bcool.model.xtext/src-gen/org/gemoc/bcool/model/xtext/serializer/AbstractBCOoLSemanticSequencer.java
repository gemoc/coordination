...
public abstract class AbstractBCOoLSemanticSequencer extends XbaseSemanticSequencer {
	 ...
	 *     name=ID
	 */
	protected void sequence_globalDSEsRule(EObject context, DefPropertyCS semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
